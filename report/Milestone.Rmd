...
The next tables shows the top 10 words.
...
news
```{r nw_table4, echo=FALSE}

nw_words %>% slice_head(n = 10)

```

line and word counts average number of words per line top 10 frequent words in
all sources plot
...
different distributions of words and ngrams in the sources with / without
stopwords - what is the percentage of stopwords in the bigrams/trigrams?

## Future Steps

Any chance to consider the type of text when guessing the next word? maybe
dependent on the application (chat more like twitter, wordpress more like blogs,
etc. )

Use the sbo package to creat
