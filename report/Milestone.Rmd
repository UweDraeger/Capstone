...
their frequency. This raises the question whether a real-life application may
benefit from being created from a context-related text source. If the tool is to
...
Although we agree to such idea we may not follow this course in the capstone project. 

However, any out of sample testing in the model development will have to be based on a test dataset from the very same source the training dataset came from. Using twitter data to train while testing on news data will downward bias the assessed predictive ability.
